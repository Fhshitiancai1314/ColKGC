...
def getLen(dataset, filename):
    file_name = os.path.join(dataset, filename)
...
def parse_args_wn18rr(args=None):
    OUTPUT_DIR = './checkpoint/wn18rr_'+ datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    ...
    parser.add_argument('--task', default='wn18rr', type=str, metavar='N',
                        help='dataset name')
    parser.add_argument('--train-path', default=DATA_DIR+'/traintxt.json', type=str, metavar='N',
                        help='path to training data')
    parser.add_argument('--valid-path', default=DATA_DIR+'/valid.txt.json', type=str, metavar='N',
                        help='path to valid data')
    parser.add_argument('--model-dir', default=OUTPUT_DIR, type=str, metavar='N',
    ...
    parser.add_argument('--use-link-graph', action='store_true', default=True,
                        help='use neighbors from link graph as context')
    parser.add_argument('--eval-every-n-step', default=10000, type=int,
                        help='evaluate every n steps')

    parser.add_argument('--pre-batch', default=8, type=int,
    ...
    parser.add_argument('--finetune-t', action='store_true', default=True,
                        help='make temperature as a trainable parameter or not')
    parser.add_argument('--max-num-tokens', default=50, type=int,
                        help='maximum number of tokens')

    parser.add_argument('--use-self-negative', action='store_true', default=True,
...
def wn18rr_for_test(args=None):
    OUTPUT_DIR = '/E22301276/SimKGC-main/checkpoint/wn18rr_'+ datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    DATA_DIR = '/E22301276/SimKGC-main/data/WN18RR'

    parser = argparse.ArgumentParser(description='SimKGC arguments')
    parser.add_argument('--pretrained-model', default='/E22301276/SimKGC-main/bert-base-uncased', type=str, metavar='N',
                        help='path to pretrained model')
    parser.add_argument('--task', default='wn18rr', type=str, metavar='N',
                        help='dataset name')

    parser.add_argument('--path', default=DATA_DIR, type=str, metavar='N',
                        help='dataset path')

    parser.add_argument('--train-path', default=DATA_DIR+'/train.txt.json', type=str, metavar='N',
                        help='path to training data')
    parser.add_argument('--valid-path', default=DATA_DIR+'/valid.txt.json', type=str, metavar='N',
                        help='path to valid data')
    parser.add_argument('--model-dir', default=OUTPUT_DIR, type=str, metavar='N',
    ...
    # only used for evaluation
    parser.add_argument('--is-test', action='store_true', default=True,
                        help='is in test mode or not')
    parser.add_argument('--rerank-n-hop', default=5, type=int,
                        help='use n-hops node for re-ranking entities, only used during evaluation')
    parser.add_argument('--neighbor-weight', default=0.05, type=float,
                        help='weight for re-ranking entities')
    parser.add_argument('--eval-model-path', default='/E22301276/SimKGC-main/checkpoint/wn18rr_2024-06-23/model_last.mdl', type=str, metavar='N',
                        help='path to model, only used for evaluation')

    return parser.parse_args(args)

def parse_args_fb(args=None):
    OUTPUT_DIR = './checkpoint/fb15k237_'+ datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
    DATA_DIR = './data/FB15k237'

    parser = argparse.ArgumentParser(description='SimKGC arguments')
    parser.add_argument('--pretrained-model', default='/E22301291/SimKGCv2/bert-base-uncased', type=str, metavar='N',
                        help='path to pretrained model')
    ...
    parser.add_argument('--warmup', default=400, type=int, metavar='N',
                        help='warmup steps')
    parser.add_argument('--max-to-keep', default=10, type=int, metavar='N',
                        help='max number of checkpoints to keep')
    parser.add_argument('--grad-clip', default=10.0, type=float, metavar='N',
                        help='gradient clipping')
    parser.add_argument('--pooling', default='mean', type=str, metavar='N',
    ...
    parser.add_argument('--t', default=0.05, type=float,
                        help='temperature parameter')
    parser.add_argument('--use-link-graph', action='store_true', default=False,
                        help='use neighbors from link graph as context')
    parser.add_argument('--eval-every-n-step', default=10000, type=int,
                        help='evaluate every n steps')
#     2
...
n_ent = getLen(args.path, 'entities.dict')
n_rel = getLen(args.path, 'relations.dict')
